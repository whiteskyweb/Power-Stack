 ...
 * @endcode
 */
$settings['hash_salt'] = 'akV7jyV5sJ91_HUJLXOztTlN9Fbq03NhuIzIhIMxmFdEH7hj0A8x0y0haXoQXWZFE6DT5OhNzQ';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_web_stripped_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_web_stripped_dd.inc';
}
// </DDSETTINGS>
